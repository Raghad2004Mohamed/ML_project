...
# Sample CSV download
with st.sidebar:
    with open("Epileptic Seizure Recognition.csv", "rb") as sample_file:
        st.download_button("📥 Download Sample CSV", sample_file, "Epileptic Seizure Recognition.csv", "text/csv")
